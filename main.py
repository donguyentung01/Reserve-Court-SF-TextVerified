...
if __name__ == "__main__": 
    ...
    court, start_time, end_time, email, password, phone_number, sid, auth_token, date, sport, slot, target_time, is_multithreaded = (
        args.court, args.starttime, args.endtime, args.email, args.password, args.phone, args.sid, args.authtoken, args.date, args.sport, args.slot, args.targettime, args.multithreaded
    )
