...
if __name__ == "__main__": 
    ...
    parser.add_argument('-n', '--phone', type=str, required=True, help="Text Verified phone number")
    parser.add_argument('-u', '--username', type=str, required=True, help="Text Verified username")
    parser.add_argument('-a', '--apikey', type=str, required=True, help="Text Verified API key")
    ...
    court, start_time, end_time, email, password, phone_number, username, api_key, date, sport, target_time, is_multithreaded = (
        args.court, args.starttime, args.endtime, args.email, args.password, args.phone, args.username, args.apikey, args.date, args.sport, args.targettime, args.multithreaded
    )
    ...
    book_court(court, date, sport, start_time, end_time, email, password, phone_number, username, api_key, is_multithreaded, target_time) 
